...
#      'Cookie' => cookie,
  ...
  def content_type
    if !file_exists? || file_name.end_with?('.html')
      'text/html'
    else if !file_exists? || file_name.end_with?('.css')
      'text/css'
         else if !file_exists? || file_name.end_with?('.js')
                'text/javascript'
              else if !file_exists? || file_name.end_with?('.ico')
  ...
  #def content_type
  #  case !file_exists?
  #  when !file_exists? || file_name.end_with?('.html')
  #    'text/html'
  #    puts 'html'
  #  when !file_exists? || file_name.end_with?('.css')
  #    'tdasdext/csdsdsdsdsds'
  #    puts 'css'
  #  else
  #    'application/octet-stream'
  #    puts 'css'
